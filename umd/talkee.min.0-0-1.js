(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?module.exports=f():typeof define==='function'&&define.amd?define(f):(g=typeof globalThis!=='undefined'?globalThis:g||self,g.Talkee=f());}(this,(function(){'use strict';var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};
...
};var engineUserAgent = getBuiltIn('navigator', 'userAgent') || '';var process$4 = global$1.process;
...
};var slice$3 = entryVirtual('Array').slice;var ArrayPrototype$5 = Array.prototype;

var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$5 || (it instanceof Array && own === ArrayPrototype$5.slice) ? slice$3 : own;
};var slice$2 = slice_1;var slice$1 = slice$2;// `Array.prototype.{ indexOf, includes }` methods implementation
...
});var indexOf$3 = entryVirtual('Array').indexOf;var ArrayPrototype$4 = Array.prototype;

var indexOf_1 = function (it) {
  var own = it.indexOf;
  return it === ArrayPrototype$4 || (it instanceof Array && own === ArrayPrototype$4.indexOf) ? indexOf$3 : own;
};var indexOf$2 = indexOf_1;var indexOf$1 = indexOf$2;var hiddenKeys = {};var indexOf = arrayIncludes.indexOf;
...
_export({ target: 'Object', stat: true, forced: Object.assign !== objectAssign }, {
  assign: objectAssign
});var assign$2 = path.Object.assign;var assign$1 = assign$2;var assign = assign$1;var keys = shared('keys');
...
};var iterators = {};var ITERATOR$6 = wellKnownSymbol('iterator');
var ArrayPrototype$3 = Array.prototype;

// check on default Array iterator
var isArrayIteratorMethod = function (it) {
  return it !== undefined && (iterators.Array === it || ArrayPrototype$3[ITERATOR$6] === it);
...
var inspectSource = sharedStore.inspectSource;var ITERATOR$4 = wellKnownSymbol('iterator');
...
};var engineIsIos = /(iphone|ipod|ipad).*applewebkit/i.test(engineUserAgent);var location = global$1.location;
...
var task$1 = {
  set: set$1,
  clear: clear
};var engineIsWebosWebkit = /web0s(?!.*chrome)/i.test(engineUserAgent);var getOwnPropertyDescriptor = objectGetOwnPropertyDescriptor.f;
...
var nativeWeakMap = typeof WeakMap$1 === 'function' && /native code/.test(inspectSource(WeakMap$1));var WeakMap = global$1.WeakMap;
var set, get, has;
...
}var promise$2 = path.Promise;var promise$1 = promise$2;var promise = promise$1;// a string of all valid unicode whitespaces
var whitespaces = '\u0009\u000A\u000B\u000C\u000D\u0020\u00A0\u1680\u2000\u2001\u2002' +
...
});var trim$4 = entryVirtual('String').trim;var StringPrototype$1 = String.prototype;

var trim_1 = function (it) {
  var own = it.trim;
  return typeof it === 'string' || it === StringPrototype$1
    || (it instanceof String && own === StringPrototype$1.trim) ? trim$4 : own;
};var trim$3 = trim_1;var trim$2 = trim$3;var SPECIES = wellKnownSymbol('species');
...
});var forEach$3 = entryVirtual('Array').forEach;var forEach$2 = forEach$3;var ArrayPrototype$2 = Array.prototype;
...
};var forEach$1 = forEach_1;var ITERATOR$1 = wellKnownSymbol('iterator');
...
_export({ global: true, forced: !nativeUrl, sham: !descriptors }, {
  URL: URLConstructor
});var url$2 = path.URL;var url$1 = url$2;var url = url$1;var $stringify = getBuiltIn('JSON', 'stringify');
var re = /[\uD800-\uDFFF]/g;
var low = /^[\uD800-\uDBFF]$/;
var hi = /^[\uDC00-\uDFFF]$/;
...
};var stringify$1 = stringify$2;var stringify = stringify$1;var trim$1 = stringTrim.trim;
...
});var _parseInt$2 = path.parseInt;var _parseInt$1 = _parseInt$2;var _parseInt = _parseInt$1;var $includes = arrayIncludes.includes;
...
});var includes$4 = entryVirtual('Array').includes;var MATCH$1 = wellKnownSymbol('match');
...
});var includes$3 = entryVirtual('String').includes;var ArrayPrototype$1 = Array.prototype;
...
};var includes$1 = includes$2;var includes = includes$1;var slice = [].slice;
...
});var setTimeout$2 = path.setTimeout;var setTimeout$1 = setTimeout$2;var entries$2 = entryVirtual('Array').entries;var entries$1 = entries$2;var ArrayPrototype = Array.prototype;
...
axios_1.default = _default;var axios = axios_1;// @TODO refactor

var CLIENT_ID = 'bf07d6d6-4d15-46ab-b5e4-6e66fac1151e';
var API_BASE = 'https://links-login.getlinks.jp/api';
var LOGIN_BASE = "https://oauth.getlinks.jp";
var LOGIN_URL = LOGIN_BASE + "?client_id=" + CLIENT_ID + "&scope=PROFILE:READ+PHONE:READ&state=";
var TWEET_BASE = 'https://twitter.com/intent/tweet';
var DEFAULT_AVATAR = 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDgiIGhlaWdodD0iNDgiIHZpZXdCb3g9IjAgMCA0OCA0OCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPGNpcmNsZSBjeD0iMjQiIGN5PSIyNCIgcj0iMjQiIGZpbGw9IiNGM0YzRjMiLz4KPC9zdmc+Cg=='; // locale
// @TODO refactor
...
var getCurrentLocale = function getCurrentLocale() {
  ...
  return slice$1(lang).call(lang, 0, 2);
};
...
var Base64 = {
  ...
  decode: function decode(input) {
    ...
    while (i < input.length) {
      ...
      enc1 = indexOf$1(_context = this._keyStr).call(_context, input.charAt(i++));
      enc2 = indexOf$1(_context2 = this._keyStr).call(_context2, input.charAt(i++));
      enc3 = indexOf$1(_context3 = this._keyStr).call(_context3, input.charAt(i++));
      enc4 = indexOf$1(_context4 = this._keyStr).call(_context4, input.charAt(i++));
      chr1 = enc1 << 2 | enc2 >> 4;
...
var Talkee = function Talkee(opts) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (opts.headers) {
              headers = assign(headers, opts.headers);
            }
            ...
            if (opts.params) {
              params = assign(params, opts.params);
            }
          ...
          case 4:
            if ((_a = resp === null || resp === void 0 ? void 0 : resp.data) === null || _a === void 0 ? void 0 : _a.token) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            e_2 = _b.sent();
            console.log('failed to auth', e_2);
            return [3
            /*break*/
            , 4];
          ...
          case 4:
            if (Talkee.getRedirect()) {
              window.location.replace((_a = Talkee.getRedirect()) !== null && _a !== void 0 ? _a : '');
              return [2
              /*return*/
              ];
            }
  ...
  this.sendComment = function () {
    return __awaiter(this, void 0, void 0, function () {
      var area, text, myComment, e_3, container;
      return __generator(this, function (_a) {
        var _context5;

        switch (_a.label) {
          case 0:
            area = this.commentsContainer.querySelector('.textarea');
            text = trim$2(_context5 = area.value).call(_context5);
          ...
          case 3:
            ...
            if (e_3.response && e_3.response.status === 400) {
          ...
          case 4:
            if (myComment) {
              area.value = '';
              container = this.commentsContainer.querySelector('.talkee-comments');
  ...
  this.checkTextareaStatus = function (area) {
    ...
    if (trim$2(_context6 = area.value).call(_context6).length === 0) {
      btn.disabled = true;
    } else {
      btn.disabled = false;
    }
  ...
  this.applySortMethod = function (method) {
    ...
    forEach$1(_context7 = this.commentsContainer.querySelectorAll('.talkee-sort-button')).call(_context7, function (x) {
      x.disabled = false;
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            err_1 = _a.sent();
            console.log('get comments error:', err_1);
            this.updateComments([]);
            return [3
            /*break*/
            , 3];
  ...
  this.buildCommentUI = function (comment) {
    var self = this;
    var commentCan = Talkee.$e('div', {
      id: 'talkee-comment-' + comment.id,
      className: 'talkee-comment'
    }); // left

    var commentLeft = Talkee.$e('div', {
      className: 'talkee-comment-left'
    }); // avatar

    var commentAvatar = Talkee.$e('img', {
      className: 'talkee-comment-avatar',
      src: comment.creator['avatar_url'] || self.defaultAvatarUrl
    });
    commentLeft.appendChild(commentAvatar);
    commentCan.appendChild(commentLeft); // right

    var commentRight = Talkee.$e('div', {
      className: 'talkee-comment-right'
    }); // right top

    var commentRT = Talkee.$e('div', {
      className: 'talkee-comment-right-top'
    }); // right top > name

    var commentName = Talkee.$e('a', {
      className: 'talkee-comment-name surprise',
      innerText: comment.creator['full_name']
    }); // right top > time

    var commentTime = Talkee.$e('span', {
    ...
    if (comment.reward && comment.reward.amount) {
      var commentReward = Talkee.$e('span', {
        className: "talkee-comment-reward"
      });
      var commentRewardIcon = Talkee.$e('span', {
        className: 'talkee-comment-reward-icon'
      });
      var commentRewardText = Talkee.$e('span', {
    ...
    commentRight.appendChild(commentRT); // content

    var commentContent = Talkee.$e('div', {
      className: 'talkee-comment-content'
    });
    var commentText = Talkee.parseText(comment.content);

    if (comment.recipient) {
      commentText = '<a href="#comment-' + comment.recipient.id + '" class="link">@' + comment.recipient.name + '</a> ' + commentText;
    }

    commentContent.innerHTML = commentText;
    commentRight.appendChild(commentContent); // favor & tweet

    var metaContent = Talkee.$e('div', {
      className: 'talkee-comment-meta'
    });
    var tweetButton = Talkee.$e('button', {
      className: 'talkee-button talkee-meta-tweet-button',
      innerText: ''
    });
    tweetButton.addEventListener('click', function () {
      var commentURL = new url(window.location.href);
      ...
      var url$1 = TWEET_BASE + "?text=" + encodeURIComponent(text) + "&url=" + encodeURIComponent(commentURL.toString()) + "&related=LinksNewsTopics";
      window.open(url$1);
    });
    metaContent.appendChild(tweetButton);
    var favWrapper = Talkee.$e('div', {
      className: 'talkee-meta-like-button-wrapper'
    });
    var favCount = Talkee.$e('span', {
      innerText: comment["favor_count"] || ''
    });
    favWrapper.appendChild(favCount);
    var favButton = Talkee.$e('button', {
      className: "talkee-button talkee-meta-like-button " + (comment["favored"] ? 'favored' : ''),
      innerText: $t('like')
    });
    favButton.addEventListener('click', function () {
      if (!self.isSigned) {
        var loginUrl = self.buildLoginURL();
  ...
  this.prependComments = function (can, comments) {
    ...
    forEach$1(comments).call(comments, function (comment) {
      var commentEle = self.buildCommentUI(comment);
  ...
  this.updateComments = function (comments) {
    var container = this.commentsContainer.querySelector('.talkee-comments');
    container.innerHTML = '';

    if (comments && comments.length) {
      this.appendComments(container, comments); // update pagination
  ...
  this.buildLoginURL = function () {
    var state = Base64.encode(stringify({
      s: this.siteId,
      p: this.slug
    }));
  ...
  this.buildEditorUI = function (container) {
    var self = this;
    var editorCan = Talkee.$e('div', {
      className: 'talkee-editor'
    }); // left

    var editorLeft = Talkee.$e('div', {
      className: 'talkee-editor-left'
    }); // avatar

    var editorAvatar = Talkee.$e('img', {
    ...
    editorCan.appendChild(editorLeft); // .talkee-editor > editor area

    var editorRight = Talkee.$e('div', {
      className: 'talkee-editor-right'
    });
    var editorArea = Talkee.$e('textarea', {
    ...
    var editorCtrl = Talkee.$e('div', {
      className: 'talkee-editor-ctrl'
    });
    var editorSubmit = Talkee.$e('button', {
    ...
    editorCan.appendChild(editorRight); // disabled editor

    if (!self.isSigned) {
      editorCan.classList.add('blur');
      var loginUrl = self.buildLoginURL();
      var editorMask = Talkee.$e('div', {
  ...
  this.buildSortBarUI = function (container) {
    var self = this;
    var sortBar = Talkee.$e('div', {
      className: 'talkee-sort-bar'
    });
    var sortBarLeft = Talkee.$e('div', {
      className: 'talkee-sort-bar-left'
    });
    var sortBarCommentIcon = Talkee.$e('span', {
      className: 'talkee-sort-bar-comment-icon'
    });
    var sortBarCommentCount = Talkee.$e('span', {
    ...
    var sortBarRight = Talkee.$e('div', {
      className: 'talkee-sort-bar-right'
    });
    var sortIcon = Talkee.$e('span', {
      className: 'talkee-sort-icon'
    });
    var sortPrefix = Talkee.$e('span', {
      className: 'talkee-sort-prefix',
      innerText: ""
    });
    sortBarRight.appendChild(sortIcon);
    sortBarRight.appendChild(sortPrefix);
    var sortByFavButton = Talkee.$e('button', {
    ...
    var sortByIdButton = Talkee.$e('button', {
    ...
    var sortByIdAscButton = Talkee.$e('button', {
  ...
  this.buildPaginationUI = function (container, comments) {
    var self = this; // [prev] [1], [2], [3] ... [n] [next]

    var paginationCan = Talkee.$e('div', {
      className: 'talkee-pagination'
    });
    var pageIndicators = Talkee.$e('div', {
      className: 'talkee-pagination-indicators'
    });
    var prevPageButton = Talkee.$e('button', {
      className: 'talkee-button talkee-pagination-button talkee-pagination-prev-button',
    ...
    var nextPageButton = Talkee.$e('button', {
      className: 'talkee-button talkee-pagination-button talkee-pagination-next-button',
    ...
    var prefixIndicatorCount = Math.min(this.totalPage, 3);

    var _loop_1 = function _loop_1(ix) {
      var btn = Talkee.$e('button', {
    ...
    for (var ix = 0; ix < prefixIndicatorCount; ix++) {
      _loop_1(ix);
    }
  ...
  this.buildLoadingUI = function () {
    if (this.commentsContainer) {
      this.commentsContainer.innerHTML = '<div class="talkee">' + '<div class="talkee-loading>' + $t('loading') + '</div>' + '</div>';
    }
  };

  this.buildTalkeeUI = function () {
    var self = this;
    this.commentsContainer.innerHTML = "<div class=\"talkee " + (this.expandable ? 'expandable' : '') + "\"></div>"; // build talkee sort bar

    this.buildSortBarUI(this.commentsContainer.children[0]); // build talkee editor

    this.buildEditorUI(this.commentsContainer.children[0]); // create an empty .comments

    var commentsCan = Talkee.$e('div', {
      className: "talkee-comments"
    });
    var expansionPanel = Talkee.$e('div', {
      className: 'talkee-expansion-panel'
    });
    var expansionPanelInner = Talkee.$e('div', {
      className: 'talkee-expansion-panel-inner'
    });
    var expandButton = Talkee.$e('button', {
      ...
      return __generator(this, function (_a) {
        ...
        switch (_a.label) {
          case 0:
            ...
            this.buildLoadingUI();
            query = Talkee.getUrlQuery();
            if (!query.code) return [3
            /*break*/
            , 2]; // auth and get the token

            return [4
            /*yield*/
            , this.auth(query.code)];
          ...
          case 3:
            if (query.talkee_page) {
              try {
                this.page = _parseInt(query.talkee_page);
              } catch (e) {}
            }
            ...
            if (query.talkee_order) {
              ...
              if (includes(_context8 = ['id', 'id-asc', 'favor_count']).call(_context8, query.talkee_order)) {
                this.sortMethod = query.talkee_order;
              }
            } // redirect to


            if (window.location.hash && indexOf$1(_context9 = window.location.hash).call(_context9, '#talkee-anchor') === 0) {
              setTimeout$1(function () {
                var m = /comment-(\d+)/.exec("#talkee-anchor-comment-15");

                if (m && m.length > 1) {
                  var anchor = _this.commentsContainer.querySelector("#talkee-comment-" + m[1]);
                ...
                _this.commentsContainer.scrollIntoView();
              }, 1000);
            }
...
Talkee.getUrlQuery = function () {
  var url$1 = new url(window.location.href);
  var ret = {};

  for (var _i = 0, _a = entries(_context10 = url$1.searchParams).call(_context10); _i < _a.length; _i++) {
    var _context10;
...
Talkee.setProfile = function (me) {
  localStorage.setItem("talkee-profile", stringify(me));
};
...
Talkee.getProfile = function () {
  ...
  try {
    return JSON.parse((_a = localStorage.getItem("talkee-profile")) !== null && _a !== void 0 ? _a : '') || null;
  } catch (e) {
    return null;
  }
};
...
Talkee.setRedirect = function () {
  ...
  var url = window.location.href.replace(/code=[a-z0-9A-Z]+/, 'code=').replace(/state=[a-z0-9A-Z]+/, 'state=');
...
Talkee.formatTime = function (timeStr) {
  ...
  var ret = pad(ds.getMonth() + 1) + "/" + pad(ds.getDate()) + " " + pad(ds.getHours()) + ":" + pad(ds.getMinutes());
...
Talkee.inject = function (link) {
  return __awaiter(this, void 0, void 0, function () {
    var tag, script;
    return __generator(this, function (_a) {
      tag = 'script';

      if (slice$1(link).call(link, link.length - 4) === '.css') {
        tag = 'link';
      }
...
}var css_248z = "* {\n  box-sizing: border-box;\n  margin: 0;\n}\n\n.talkee {\n  margin: 0 auto;\n  padding: 20px 0;\n  font-family: inherit;\n  position: relative;\n}\n@media screen and (max-width: 768px) {\n  .talkee {\n    padding: 16px;\n  }\n}\n\n.talkee .talkee-button {\n  height: 42px;\n  padding: 8px 12px;\n  font-size: inherit;\n  border: 1px solid #e0e0e0;\n  border-radius: 6px;\n  background: transparent;\n  margin: 0 4px;\n  cursor: pointer;\n}\n\n.talkee.expandable {\n  max-height: 600px;\n  overflow: hidden;\n}\n\n.talkee .talkee-expansion-panel {\n  display: none;\n}\n\n.talkee.expandable .talkee-expansion-panel {\n  display: block;\n  position: absolute;\n  height: 120px;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  z-index: 10;\n  background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #ffffff 40%);\n}\n\n.talkee .talkee-expansion-panel-inner {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.talkee .talkee-expand-button {\n  margin: 40px auto;\n}\n\n.talkee .talkee-editor {\n  width: 100%;\n  margin-bottom: 20px;\n  border: 1px solid rgba(0, 0, 0, 0.15);\n  background: transparent;\n  position: relative;\n  border-radius: 8px;\n  display: flex;\n}\n.talkee .talkee-editor-left {\n  flex-basis: 64px;\n}\n.talkee .talkee-editor-right {\n  flex: 1;\n}\n.talkee .talkee-editor-avatar {\n  width: 48px;\n  height: 48px;\n  border-radius: 20em;\n  margin-top: 0px;\n}\n.talkee .talkee-editor-area {\n  outline: none;\n  border: none;\n  width: 100%;\n  line-height: 1.3;\n  resize: none;\n  overflow: hidden;\n  min-height: 24px;\n  max-height: 800px;\n}\n.talkee .talkee-editor-ctrl {\n  padding: 10px;\n  width: 100%;\n  display: flex;\n  justify-content: flex-end;\n}\n.talkee .talkee-editor-submit {\n  padding: 8px 12px;\n  height: 42px;\n  background: #000;\n  color: #fff;\n  border: none;\n  outline: none;\n  font-size: inherit;\n  transition: all 0.3s ease;\n  justify-content: center;\n  align-items: center;\n}\n\n.talkee .talkee-editor-submit[disabled] {\n  opacity: 0.5;\n}\n\n.talkee .talkee-editor-mask {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.talkee .talkee-editor.blur .talkee-editor-area,\n.talkee .talkee-editor.blur .talkee-editor-left,\n.talkee .talkee-editor.blur .talkee-editor-ctrl {\n  -webkit-filter: blur(6px) grayscale(50%);\n  filter: blur(6px) grayscale(50%);\n}\n.talkee .talkee-tap-to-login {\n  text-decoration: none;\n  font-weight: bold;\n  font-size: 13px;\n}\n.talkee .talkee-comments {\n  margin-top: 0px;\n}\n.talkee .talkee-comment {\n  background-image: url(\"./comment-header.svg\");\n  background-repeat: no-repeat;\n  background-position: 60px 10px;\n  margin-bottom: 32px;\n  display: flex;\n}\n.talkee .talkee-comment-left {\n  flex-basis: 64px;\n}\n.talkee .talkee-comment-avatar {\n  margin-top: 15px;\n  height: 48px;\n  width: 48px;\n  border-radius: 99em;\n}\n.talkee .talkee-comment-right {\n  flex: 1;\n  padding: 10px 0;\n}\n.talkee .talkee-comment-right-top {\n  font-size: 13px;\n  padding: 20px 10px 10px 10px;\n  display: flex;\n  align-items: center;\n}\n.talkee .talkee-comment-name {\n  margin-right: 10px;\n  font-weight: bold;\n}\n.talkee .talkee-comment-time {\n  opacity: 0.6;\n}\n.talkee .talkee-comment-reward {\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  flex: 1;\n  color: #eba131;\n}\n.talkee .talkee-comment-reward-icon {\n  background: transparent url(./badge.svg) 0 0 no-repeat;\n  background-size: 24px;\n  width: 24px;\n  height: 24px;\n}\n.talkee .talkee-comment-reply-button {\n  float: right;\n}\n.talkee .talkee-comment-content {\n  padding: 10px;\n  word-break: break-word;\n  line-height: 1.3;\n}\n\n.talkee .talkee-comment-meta {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-left: -4px;\n}\n\n.talkee .talkee-meta-like-button,\n.talkee .talkee-meta-tweet-button {\n  height: 24px;\n  background-size: 24px;\n  border: none;\n  outline: none;\n  padding: 0;\n  cursor: pointer;\n  font-size: 13px;\n  height: 24px;\n  display: inline-block;\n  min-width: 24px;\n}\n\n.talkee .talkee-meta-like-button-wrapper {\n  font-size: 13px;\n}\n\n.talkee .talkee-meta-like-button {\n  padding-left: 24px;\n  background: transparent url(./like.svg) 0 0 no-repeat;\n}\n\n.talkee .talkee-meta-tweet-button {\n  background: transparent url(./tweet.svg) 0 0 no-repeat;\n}\n\n.talkee .talkee-meta-like-button {\n  color: #000;\n}\n\n.talkee .talkee-meta-like-button.favored {\n  opacity: 1;\n  background: transparent url(./liked.svg) 0 0 no-repeat;\n  color: #5a97a6;\n}\n\n.talkee .talkee-sort-bar {\n  margin-bottom: 16px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  font-size: 13px;\n}\n\n.talkee .talkee-sort-bar-left {\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n}\n\n.talkee .talkee-sort-bar-right {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n}\n\n.talkee .talkee-sort-bar-comment-icon {\n  width: 24px;\n  height: 24px;\n  background: transparent url(./comment.svg) 0 0 no-repeat;\n  background-size: 24px;\n}\n\n.talkee .talkee-sort-button {\n  opacity: 0.5;\n  border: none;\n  outline: none;\n  background: transparent;\n  cursor: pointer;\n  padding: 0;\n  margin-right: 10px;\n  font-size: inherit;\n}\n\n.talkee .talkee-sort-prefix {\n  margin-right: 10px;\n  display: none;\n}\n\n.talkee .talkee-sort-icon {\n  display: inline-block;\n  margin-right: 4px;\n  width: 24px;\n  height: 24px;\n  background: transparent url(./sort.svg) 0 0 no-repeat;\n  background-size: 24px;\n}\n\n.talkee .talkee-sort-button[disabled] {\n  opacity: 1;\n  font-weight: bold;\n  color: #5a97a6;\n}\n\n.talkee .talkee-sort-by-id-asc-button {\n  margin-right: 0;\n}\n\n.talkee .talkee-pagination {\n  display: flex;\n  justify-content: center;\n  font-size: 16px;\n}\n.talkee .talkee-pagination-button {\n  height: 42px;\n  padding: 8px 12px;\n  font-size: inherit;\n  border: 1px solid #e0e0e0;\n  box-sizing: border-box;\n  border-radius: 6px;\n  background: transparent;\n  margin: 0 4px;\n  cursor: pointer;\n}\n.talkee .talkee-pagination-button[disabled] {\n  opacity: 0.5;\n}\n\n.talkee .talkee-no-comment-hint {\n  text-align: center;\n  opacity: 0.6;\n}\n";
styleInject(css_248z);return Talkee;})));