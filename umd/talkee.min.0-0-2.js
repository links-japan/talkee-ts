...
};var hiddenKeys = {};var indexOf$3 = arrayIncludes.indexOf;
...
var isArrayIteratorMethod = function (it) {
  return it !== undefined && (iterators.Array === it || ArrayPrototype$4[ITERATOR$6] === it);
...
});var forEach$3 = entryVirtual('Array').forEach;var forEach$2 = forEach$3;var ArrayPrototype$3 = Array.prototype;
...
});var includes$3 = entryVirtual('String').includes;var ArrayPrototype$2 = Array.prototype;
var StringPrototype = String.prototype;

var includes$2 = function (it) {
  var own = it.includes;
  if (it === ArrayPrototype$2 || (it instanceof Array && own === ArrayPrototype$2.includes)) return includes$4;
  if (typeof it === 'string' || it === StringPrototype || (it instanceof String && own === StringPrototype.includes)) {
    return includes$3;
  } return own;
};var includes$1 = includes$2;var includes = includes$1;/* eslint-disable es/no-array-prototype-indexof -- required for testing */
...
});var indexOf$2 = entryVirtual('Array').indexOf;var ArrayPrototype$1 = Array.prototype;

var indexOf_1 = function (it) {
  var own = it.indexOf;
  return it === ArrayPrototype$1 || (it instanceof Array && own === ArrayPrototype$1.indexOf) ? indexOf$2 : own;
};var indexOf$1 = indexOf_1;var indexOf = indexOf$1;var slice = [].slice;
...
axios_1.default = _default;var axios = axios_1;var Base64 = {
  // private property
  ...
  decode: function decode(input) {
    ...
    while (i < input.length) {
      ...
      enc1 = indexOf(_context = this._keyStr).call(_context, input.charAt(i++));
      enc2 = indexOf(_context2 = this._keyStr).call(_context2, input.charAt(i++));
      enc3 = indexOf(_context3 = this._keyStr).call(_context3, input.charAt(i++));
      enc4 = indexOf(_context4 = this._keyStr).call(_context4, input.charAt(i++));
      chr1 = enc1 << 2 | enc2 >> 4;
...
var CLIENT_ID = '3a6c513a-a189-4586-a0f8-cba80ed84de8';
...
var Talkee = function Talkee(opts) {
      ...
      return __generator(this, function (_a) {
        ...
        switch (_a.label) {
          case 0:
            ...
            text = trim$2(_context = area.value).call(_context);
  ...
  this.checkTextareaStatus = function (area) {
    ...
    if (trim$2(_context2 = area.value).call(_context2).length === 0) {
      btn.disabled = true;
    } else {
      btn.disabled = false;
    }
  ...
  this.applySortMethod = function (method) {
    ...
    forEach$1(_context3 = this.commentsContainer.querySelectorAll('.talkee-sort-button')).call(_context3, function (x) {
      x.disabled = false;
    });
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            if (query.talkee_order) {
              ...
              if (includes(_context4 = ['id', 'id-asc', 'favor_count']).call(_context4, query.talkee_order)) {
                this.sortMethod = query.talkee_order;
              }
            } // redirect to


            if (window.location.hash && indexOf(_context5 = window.location.hash).call(_context5, '#talkee-anchor') === 0) {
...
Talkee.getUrlQuery = function () {
  ...
  for (var _i = 0, _a = entries(_context6 = url$1.searchParams).call(_context6); _i < _a.length; _i++) {
    var _context6;
